...
function add_node(
  label: string,
  is_leaf: boolean,
  children: Array<FavoriteTreeNode> | null = null
) {
...
<template>
  <div class="favorite-container">
      ...
      <div class="action-buttons">
        ...
        <ElTooltip :content="$t('favorite.add_game')" placement="bottom">
          <ElButton
            ...
            circle
            class="action-button"
            @click="() => (add_game_dialog_visible = true)"
          />
        </ElTooltip>
        <ElTooltip :content="$t('favorite.enable_edit')" placement="bottom">
          <ElButton
            :icon="EditPen"
            :type="enable_edit ? 'primary' : ''"
            size="small"
            circle
            class="action-button"
            @click="
    ...
    <ElTree
      ...
      @node-click="favorite_click_handler"
    ...
    <ElDialog v-model="add_game_dialog_visible" :title="$t('favorite.choose_game_add')">
      ...
      <template #footer>
        <div style="text-align: right">
          <ElButton type="primary" @click="add_all_games">{{
