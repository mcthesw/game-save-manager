      ...
      <ElForm label-position="left" :label-width="120">
        ...
        <template v-if="cloud_settings!.backend!.type === 'WebDAV'">
          ...
          <ElFormItem :label="$t('sync_settings.webdav.password')">
            <ElInput v-model="webdav_settings.password" type="password" />
          </ElFormItem>
        </template>
        <!-- WebDAV end -->
        <!-- S3 start -->
        <template v-if="cloud_settings!.backend!.type === 'S3'">
          ...
          <ElFormItem :label="$t('sync_settings.s3.secret_access_key')">
            <ElInput v-model="s3_settings.secret_access_key" type="password" />
          </ElFormItem>
        </template>
        <!-- S3 end -->
        ...
        <ElFormItem>
          <ElButton type="danger" @click="upload_all">{{
            $t('sync_settings.overwrite_upload')
          }}</ElButton>
          <ElButton type="danger" @click="download_all">{{
