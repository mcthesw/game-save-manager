...
export type CloudArchiveGameView = { game_id: string; name: string; sync_mode: SyncMode; live_save_process_name: string | null; live_save_snapshot_on_exit: boolean; retention_limit: number | null; managed: boolean; visible: boolean; advertised_head_count: number; requires_choice: boolean; snapshots: CloudArchiveSnapshotView[]; pending_deletions: CloudArchiveDeletionView[]; local_count: number; cloud_count: number }
export type CloudArchiveLibraryView = { games: CloudArchiveGameView[]; pending_materialization: boolean }
export type CloudArchiveSnapshotView = { snapshot_id: string; description: string; size: number | null; local_verified: boolean; cloud_verified: boolean; reported_on_devices: string[]; created_by: CreatedBy; retention_protected: boolean; parent: string | null }
